# Music Controller
execute as @s[tag=musicController,tag=!isFastTravelling,tag=!playingCompletionMusic] run function hp:music/music_controller
...
execute as @s[scores={musicTime=..0},tag=playingCompletionMusic] run tag @s remove playingCompletionMusic
