...
######################
# Fechadura de combinação e ninho de livros monstruosos
...
execute if score secondHandBroomCellarIsEmpty global matches 0 run scoreboard players set secondHandBroomCellarIsEmpty global 0
