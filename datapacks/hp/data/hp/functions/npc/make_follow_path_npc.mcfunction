tag @s add fpActor
execute at @s run summon villager ~ ~ ~ {Silent:1b,Invulnerable:1b,CustomNameVisible:0b,Team:"NPC",CareerLevel:1,Tags:["restorable","fpEngine","invisible","fpEngineIsBeingInitialized"],CustomName:"{\"text\":\"fpEngine\"}",Attributes:[{Name:generic.knockback_resistance,Base:1},{Name:generic.movement_speed,Base:0}],Offers:{},ArmorItems:[{},{},{},{id:"minecraft:golden_hoe",Count:1b,tag:{Unbreakable:1b,Damage:32}}]}
