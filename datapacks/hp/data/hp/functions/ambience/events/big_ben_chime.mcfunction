...
execute as @p unless entity @s[scores={lastLocation=33}] as @s[tag=!isFastTravelling,tag=!inConversation,tag=!inProperCutScene,tag=!inInventory] at @a run playsound minecraft:custom.music.ambient_safe record @s ~ ~ ~ 1000000 1 1
