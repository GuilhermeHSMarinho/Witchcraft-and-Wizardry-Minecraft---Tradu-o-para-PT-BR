...
scoreboard players set @s trackedQuestID 36
...
#### Flying lesson
execute as @s[scores={playerID=1}] run scoreboard players set hooch p1convOverride 1
execute as @s[scores={playerID=2}] run scoreboard players set hooch p2convOverride 1
execute as @s[scores={playerID=4}] run scoreboard players set hooch p4convOverride 1
execute as @s[scores={playerID=3}] run scoreboard players set hooch p3convOverride 1
tag @s add hasLearnedToFly
scoreboard players operation @s broomID = global broomID
scoreboard players add global broomID 1
execute unless entity @p[tag=!hasLearnedToFly,tag=inGame] run scoreboard players set resetFlyingClass global 1
tag @s remove broomInInventory

#### Wingardium Leviosa
tag @s add unlockedSpells
scoreboard players set @s unlockedSpell 5
scoreboard players set @s overrideRespawn 0
execute as @s[scores={playerID=1}] run scoreboard players set flitwick p1convOverride 1
execute as @s[scores={playerID=2}] run scoreboard players set flitwick p2convOverride 1
execute as @s[scores={playerID=3}] run scoreboard players set flitwick p3convOverride 1
execute as @s[scores={playerID=4}] run scoreboard players set flitwick p4convOverride 1
execute as @s[tag=gameLeader] run gamerule doDaylightCycle false
tag @s add hasLearnedWingardiumLeviosa
execute unless entity @p[scores={trackedQuestID=18}] run scoreboard players set playerInWingardiumSpellChallenge global 0

#### Bombarda Maxima
tag @s add unlockedSpells
scoreboard players set @s unlockedSpell 6
execute as @s[scores={playerID=1}] run scoreboard players set lupin p1convOverride 1
execute as @s[scores={playerID=2}] run scoreboard players set lupin p2convOverride 1
execute as @s[scores={playerID=3}] run scoreboard players set lupin p3convOverride 1
execute as @s[scores={playerID=4}] run scoreboard players set lupin p4convOverride 1
execute as @s[tag=gameLeader] run gamerule doDaylightCycle true
tag @s add hasLearnedBombardaMaxima
execute if score herbologyClassIsSetUp global matches 0 run function hp:quests/quests/herbology/setup_herbology_students
execute as @s[tag=gameLeader] run function hp:quests/quests/golden_skull/setup_golden_skull
execute unless entity @p[scores={trackedQuestID=19}] run scoreboard players set playerInBombardaSpellChallenge global 0

#### Herbology
tag @s remove earmuffsLocked
execute as @s[scores={playerID=1}] run scoreboard players set sprout p1convOverride 1
execute as @s[scores={playerID=2}] run scoreboard players set sprout p2convOverride 1
execute as @s[scores={playerID=3}] run scoreboard players set sprout p3convOverride 1
execute as @s[scores={playerID=4}] run scoreboard players set sprout p4convOverride 1
scoreboard players set rotateHerbologyStars global 0
function hp:quests/quests/herbology/remove_herbology_stars
execute unless entity @p[tag=earmuffsLocked,tag=inGame] run scoreboard players set resetHerbologyClass global 1
function hp:quests/quests/vera_verto/setup_transfiguration_classroom

#### Vera Verto
summon area_effect_cloud ~ ~ ~ {Radius:0.0f,Duration:1000,Particle:"block air",Tags:[chunkLoader]}
execute as @e[tag=chunkLoader,limit=1,sort=nearest] at @s run spreadplayers 728 136 1 1 false @s
tag @s add unlockedSpells
scoreboard players set @s unlockedSpell 7
tp @e[tag=veraVertoGoblet] ~ ~-500 ~
tp @e[tag=mcGonagallClassroomCat] ~ ~-500 ~
tp @e[tag=mcGonagallClassroomCutscene] ~ ~-500 ~
kill @e[tag=veraVertoGoblet]
kill @e[tag=mcGonagallClassroomCat]
kill @e[tag=mcGonagallClassroomCutscene]
effect clear @e[tag=veraVertoParrot,limit=1] minecraft:invisibility
tp @e[tag=mcGonagallClassroom] 724 66 140
kill @e[tag=chunkLoader]
scoreboard players set @s overrideRespawn 0
execute as @s[scores={playerID=1}] run scoreboard players set mcGonagall p1convOverride 1
execute as @s[scores={playerID=2}] run scoreboard players set mcGonagall p2convOverride 1
execute as @s[scores={playerID=3}] run scoreboard players set mcGonagall p3convOverride 1
execute as @s[scores={playerID=4}] run scoreboard players set mcGonagall p4convOverride 1
tag @s remove hasSpokenToMcGonagallAfterVeraVertoLesson
execute if score patronumClassIsSetUp global matches 0 run function hp:quests/quests/expecto_patronum/setup_expecto_patronum_lesson
execute as @s[tag=gameLeader] run gamerule doDaylightCycle false
tag @s add hasLearnedVeraVerto
execute unless entity @p[scores={trackedQuestID=20}] run scoreboard players set playerInVeraVertoSpellChallenge global 0

#### Expecto Patronum
tag @s add unlockedSpells
scoreboard players set @s unlockedSpell 8
scoreboard players set @s overrideRespawn 0
execute as @s[scores={playerID=1}] run scoreboard players set lupin p1convOverride 1
execute as @s[scores={playerID=2}] run scoreboard players set lupin p2convOverride 1
execute as @s[scores={playerID=3}] run scoreboard players set lupin p3convOverride 1
execute as @s[scores={playerID=4}] run scoreboard players set lupin p4convOverride 1
execute as @s[tag=gameLeader] run gamerule doDaylightCycle true
tag @s add hasLearnedExpectoPatronum
execute unless entity @p[scores={trackedQuestID=21}] run scoreboard players set playerInPatronusSpellChallenge global 0
execute as @s[tag=gameLeader] run function hp:quests/quests/expecto_patronum/clear_expecto_patronum_lesson

#### Apparition
tag @s add unlockedSpells
scoreboard players set @s unlockedSpell 9
scoreboard players set @s overrideRespawn 0
execute as @s[tag=gameLeader] run gamerule doDaylightCycle true
tag @s add hasLearnedApparition
execute unless entity @p[scores={trackedQuestID=22}] run scoreboard players set playerInApparitionSpellChallenge global 0
execute as @s[scores={playerID=1}] run scoreboard players set willkieTwycross p1convOverride 25
execute as @s[scores={playerID=2}] run scoreboard players set willkieTwycross p2convOverride 25
execute as @s[scores={playerID=3}] run scoreboard players set willkieTwycross p3convOverride 25
execute as @s[scores={playerID=4}] run scoreboard players set willkieTwycross p4convOverride 25

#### The Order of the Phoenix
execute as @s[scores={playerID=1}] run scoreboard players set alastorMoody p1convOverride 4
execute as @s[scores={playerID=2}] run scoreboard players set alastorMoody p2convOverride 4
execute as @s[scores={playerID=3}] run scoreboard players set alastorMoody p3convOverride 4
execute as @s[scores={playerID=4}] run scoreboard players set alastorMoody p4convOverride 4
execute as @s[scores={playerID=1}] run scoreboard players set mundungusFletcher p1convOverride 8
execute as @s[scores={playerID=2}] run scoreboard players set mundungusFletcher p2convOverride 8
execute as @s[scores={playerID=3}] run scoreboard players set mundungusFletcher p3convOverride 8
execute as @s[scores={playerID=4}] run scoreboard players set mundungusFletcher p4convOverride 8
tag @s add hasTravelledToAzkaban
tp @s 2459.89 62.00 -246.52 124.10 5.29

#### Azkaban
scoreboard players set @s overrideRespawn 0
scoreboard players set azkabanQuestIsGoing global 0
gamerule doDaylightCycle true
