...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Be careful around The Monster Book of Monsters, they can be pretty aggressive. I had to use a belt to keep mine shut. \\n\\n\\n\\n\"}"}
