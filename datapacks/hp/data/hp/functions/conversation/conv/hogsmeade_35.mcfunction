...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Tenho um enigma para você. Como o Potter mexe o caldeirão? Ele segura a varinha, e o mundo gira ao seu redor. Ha!\\n\\n\\n\\n\"}"}
