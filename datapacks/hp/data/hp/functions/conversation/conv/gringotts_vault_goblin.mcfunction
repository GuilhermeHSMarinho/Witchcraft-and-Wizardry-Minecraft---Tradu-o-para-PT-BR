...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"√ Saia dos cofres.\"}",Tags:["_____Normal_____","_____click_____","fastTravel","_____destinationGringottsTrack_____","convOption","i"]}
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] if entity @p[tag=activePlayer,tag=confirmConvOption] run data merge entity @s {CustomName:"{\"text\":\"Trilha de Gringotes\"}",Tags:["_____Normal_____","_____click_____","fastTravel","_____destinationGringottsTrack_____","convOption","i"]}
#-------------------------------
