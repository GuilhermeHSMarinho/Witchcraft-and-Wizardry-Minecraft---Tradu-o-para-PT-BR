...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Esse aqui se nocauteou com seu próprio bastão de batedor durante o treino de Quadribol. \\n\\n\\n\\n\"}"}
