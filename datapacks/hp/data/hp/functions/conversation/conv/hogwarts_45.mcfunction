...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" A Granger já tentou me recrutar pra algum tipo de organização de elfos umas doze vezes até agora. \\n\\n\\n\\n\"}"}
