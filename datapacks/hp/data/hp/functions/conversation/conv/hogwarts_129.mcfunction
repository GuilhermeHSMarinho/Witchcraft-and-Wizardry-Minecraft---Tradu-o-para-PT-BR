...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Looking for the Slytherin common room? Or the Potions classroom? These direction signs are pretty helpful, huh? \\n\\n\\n\\n\"}"}
