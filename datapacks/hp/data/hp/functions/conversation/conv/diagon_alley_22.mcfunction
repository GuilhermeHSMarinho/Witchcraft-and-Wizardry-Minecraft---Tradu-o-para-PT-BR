...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I'm getting a new pet after O'Flaherty blew up my cat in Care of Magical Creatures. Stupid git. \\n\\n\\n\\n\"}"}
