...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Just look at this stuff. I'm getting inspired to do all kinds of pranks. \\n\\n\\n\\n\"}"}
