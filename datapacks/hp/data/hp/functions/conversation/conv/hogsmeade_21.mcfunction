...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Magic is great and all. But what I wouldn't do for a ballpoint pen right now... \\n\\n\\n\\n\"}"}
