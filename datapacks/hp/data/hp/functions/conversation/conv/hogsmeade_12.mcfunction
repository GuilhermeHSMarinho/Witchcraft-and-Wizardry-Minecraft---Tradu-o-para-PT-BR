...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Dizem que o conhecimento é sua própria recompensa. Não sei sobre isso, mas eu preciso aprender a me livrar dos duendecillos — e rápido! \\n\\n\\n\\n\"}"}
