...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I'm a bit occupied here... I'm just in the middle of my homework for Arithmancy. \\n\\n\\n\\n\"}"}
