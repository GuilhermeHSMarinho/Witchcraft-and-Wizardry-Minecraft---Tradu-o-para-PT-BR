...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Are you lost? The prefects tend to hang around the study hall by the Transfiguration Courtyard. You can ask them for directions. \\n\\n\\n\"}"}
