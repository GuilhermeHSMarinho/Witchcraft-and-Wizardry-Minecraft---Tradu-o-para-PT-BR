...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Você já deu uma olhada na Cabana Assombrada? Dizem que é o prédio mais mal-assombrado da Grã-Bretanha. \\n\\n\\n\\n\"}"}
