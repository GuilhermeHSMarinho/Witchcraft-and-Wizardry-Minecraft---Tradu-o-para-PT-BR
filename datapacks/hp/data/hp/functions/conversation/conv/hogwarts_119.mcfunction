...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I love Professor Trelawney's lessons. She says I've got all the makings of a true Seer. \\n\\n\\n\\n\"}"}
