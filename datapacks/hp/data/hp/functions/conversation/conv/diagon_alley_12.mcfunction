...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Potions are really useful. And it's much cheaper to brew them yourself. \\n\\n\\n\\n\"}"}
