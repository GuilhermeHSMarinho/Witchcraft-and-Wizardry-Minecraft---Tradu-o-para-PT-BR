...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I'm getting some dungbombs. Very useful if you're ever attacked by an angry magical beast. Or a Slytherin! \\n\\n\\n\\n\"}"}
