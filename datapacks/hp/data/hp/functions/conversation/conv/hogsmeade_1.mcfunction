...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" What drivel! I'm not sure it's enough to just toss this book aside. It should be thrown with great force. \\n\\n\\n\\n\"}"}
