...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Que besteira! Não basta jogar esse livro de lado, tem que arremessar com força! \\n\\n\\n\\n\"}"}
