...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I brought my computer to school, but it appears it doesn't work here. Some weird kind of magic. I can't find any plugs either. \\n\\n\\n\"}"}
