...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Estou vendendo algumas coisas para o Samwise Wiseacre. Ele compra de tudo, então é uma ótima forma de conseguir uns galeões rapidinho. \\n\\n\\n\\n\"}"}
