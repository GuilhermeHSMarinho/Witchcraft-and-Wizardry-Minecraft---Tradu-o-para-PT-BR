...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I'm thinking about getting a toad. I know they aren't very fashionable at Hogwarts, but I've always wanted one. \\n\\n\\n\\n\"}"}
