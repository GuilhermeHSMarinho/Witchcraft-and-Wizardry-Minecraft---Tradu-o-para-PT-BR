...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Gladrag's Wizardwear is alright, but I prefer Twilfitt and Tattings in Diagon Alley. \\n\\n\\n\\n\"}"}
