...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Bem-vindo à McHavelock's Wizarding Headgear! Chapéus de Alta Qualidade, Classe e Estilo! \"}"}
