...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Aquele pombo não sai dali faz dias. Fico me perguntando o que ele vê de tão especial naquela fonte quebrada. \\n\\n\\n\\n\"}"}
