...
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Você quer alguma coisa? Fale com Branwen Scamander lá em cima. Ela está no comando. \\n\\n\\n\\n \"}"}
