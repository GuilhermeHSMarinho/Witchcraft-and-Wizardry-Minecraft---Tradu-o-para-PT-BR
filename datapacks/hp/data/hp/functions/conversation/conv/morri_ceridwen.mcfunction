...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Looking to brew some potions? They can be very useful in a pinch. \",\"color\":\"white\",\"bold\":\"false\"}"}
