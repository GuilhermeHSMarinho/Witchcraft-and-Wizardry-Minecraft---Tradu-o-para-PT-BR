...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Blasted kids everywhere. I can't wait till you lot leave for the holidays. \\n\\n\\n\\n\"}"}
