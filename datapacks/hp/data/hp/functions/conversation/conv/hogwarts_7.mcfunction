...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" These direction signs are a huge help. Without them I would never be able to find my way back to the common room.\\n\\n\\n\\n\"}"}
