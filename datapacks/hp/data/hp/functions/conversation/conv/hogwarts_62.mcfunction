...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Don't mind her. She's had that song stuck in her head ever since the last start-of-term feast. \\n\\n\\n\\n\"}"}
