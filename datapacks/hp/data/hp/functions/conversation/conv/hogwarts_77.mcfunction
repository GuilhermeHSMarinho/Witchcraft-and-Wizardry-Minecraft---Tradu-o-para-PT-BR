...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" If only that McGonagall was as good as Snape, then I might have a chance of passing my O.W.L.s. \\n\\n\\n\\n\"}"}
