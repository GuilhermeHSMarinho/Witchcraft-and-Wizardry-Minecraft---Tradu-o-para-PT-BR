...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" My friend is here because he ate a pound of doxy eggs for a bet. What an idiot. \\n\\n\\n\\n\"}"}
