...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" Oii! Eu sou... \"},{\"text\":\"Hermione Granger\",\"color\":\"gold\",\"bold\":\"true\"},{\"text\":\".\\n\\n\\n\\n\\n\",\"color\":\"white\",\"bold\":\"false\"}]"}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≤  O que é SPEW?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=3}] run data merge entity @s {CustomName:"{\"text\":\"≤ Fale-me sobre seu gato\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=4}] run data merge entity @s {CustomName:"{\"text\":\"≤ Você é nascida trouxa?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=5}] run data merge entity @s {CustomName:"{\"text\":\"≥ Cuide-se bb..\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Bom, o Chapéu Seletor realmente pensou seriamente em me colocar na Corvinal durante a seleção, mas no fim decidiu por Grifinória. Acho que Corvinal não teria sido tão ruim, mas eu sempre quis estar na Grifinória. O próprio Dumbledore foi da Grifinória. \\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" S.P.E.W. é a sigla para 'Sociedade de Promoção do Empoderamento dos Elfos (domésticos)'. Foi criada por Hermione Granger para lutar pelos direitos dos elfos domésticos, que muitas vezes são maltratados ou vivem em condições injustas no mundo bruxo. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Ele se chama Crookshanks e é bem esperto. Comprei ele na Menagerie Mágica no Beco Diagonal. Acho ele lindo, embora ninguém mais quisesse comprar.\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Sim! Meus dois pais são dentistas trouxas, mas eles aceitam muito bem o mundo bruxo. Ficaram chocados quando descobriram que eu era bruxa, mas também ficaram felizes.\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Nossa, sério? Acho que até posso te ensinar um feitiço, mas estou meio ocupado agora. Talvez se você me ajudar, eu arrumo um tempo para te ensinar.\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Isso seria ótimo!\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≥ Tem algo que eu preciso fazer primeiro\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Já tentei convencer outros alunos em Hogwarts a entrar na causa, mas ninguém se interessou muito, e os elfos domésticos parecem achar a iniciativa meio ofensiva. Eu estava esperando que a mensagem tocasse os moradores da vila próxima, Hogsmeade. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Talvez você possa me ajudar a colocar alguns panfletos em Hogsmeade para divulgar a mensagem? \\n\\n Viaje até Hogsmeade e pendure os panfletos em 5 quadros de avisos.\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Vou fazer isso...\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Volte quando tiver espalhado todos os panfletos.\\n\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Você colocou todos os panfletos? \\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Fiz isso!\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Excelente. Acho que agora posso te ensinar. Tem um feitiço que já me salvou várias vezes, embora seja meio travesso. Chama-se 'Alohomora' e serve para destrancar portas trancadas. \\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Conheço um lugar onde podemos ir para praticar.\\n\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState -1
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≥ Preciso fazer algo primeiro, Desculpe\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=2}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState -1
#-------------------------------
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Excelente! Muito bem feito. O feitiço Alohomora está desbloqueado agora. \\n\\n\\n\\n \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Acho que sua próxima aula é voo com a Madame Hooch. Pronto para voltar?\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] if entity @p[tag=activePlayer,tag=!confirmConvOption,tag=!inMemory] run data merge entity @s {CustomName:"{\"text\":\"√ Viajar para a Biblioteca\"}",Tags:["_____Normal_____","_____click_____","fastTravel","_____destinationTheLibrary_____","convOption","i"]}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≥ Quero ficar aqui mais um pouco.\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=2}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState -1
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Para usar o feitiço 'Alohomora', selecione-o no menu de feitiços pressionando ² e lance-o dando dois cliques em ⌠ enquanto estiver olhando para uma porta trancada.\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≥ Tchau...\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState -1
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Só espere todo mundo se preparar e vamos para lá.\\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Muito gentil da sua parte. Na verdade, sim — já li praticamente todas as seções interessantes da biblioteca de Hogwarts e estou procurando algo a mais para ler. \\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Se encontrar algum livro interessante ou raro, traga para mim.\\n\\n Pago 50 galeões por cada livro raro que você me trouxer. \\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"ⁿ Pode deixar!\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Isso parece interessante... Deve ser uma boa leitura!  \\n\"}"}
execute if entity @s[tag=use] run scoreboard players set @s questTextTimer 2
execute as @s[scores={playerID=1},tag=use] run bossbar set minecraft:player1quest name ["",{"text":"Venda ","color":"white"},{"score":{"name":"@s","objective":"rareBooks"},"color":"white"},{"text":" Livros raros por ","color":"white"},{"score":{"name":"@s","objective":"rareBooksMoney"},"color":"white"},{"text":" ≈","color":"white"},{"text":".","color":"white"}]
execute as @s[scores={playerID=3},tag=use] run bossbar set minecraft:player3quest name ["",{"text":"Venda ","color":"white"},{"score":{"name":"@s","objective":"rareBooks"},"color":"white"},{"text":" Livros raros por ","color":"white"},{"score":{"name":"@s","objective":"rareBooksMoney"},"color":"white"},{"text":" ≈","color":"white"},{"text":".","color":"white"}]
execute as @s[scores={playerID=2},tag=use] run bossbar set minecraft:player2quest name ["",{"text":"Venda ","color":"white"},{"score":{"name":"@s","objective":"rareBooks"},"color":"white"},{"text":" Livros raros por ","color":"white"},{"score":{"name":"@s","objective":"rareBooksMoney"},"color":"white"},{"text":" ≈","color":"white"},{"text":".","color":"white"}]
execute as @s[scores={playerID=4},tag=use] run bossbar set minecraft:player4quest name ["",{"text":"Venda ","color":"white"},{"score":{"name":"@s","objective":"rareBooks"},"color":"white"},{"text":" Livros raros por ","color":"white"},{"score":{"name":"@s","objective":"rareBooksMoney"},"color":"white"},{"text":" ≈","color":"white"},{"text":".","color":"white"}]
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ (Trocar livros raros)\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState 1
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"Deixa pra lá então.\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=2}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState 1
#-------------------------------
#===============================
# Number of options
