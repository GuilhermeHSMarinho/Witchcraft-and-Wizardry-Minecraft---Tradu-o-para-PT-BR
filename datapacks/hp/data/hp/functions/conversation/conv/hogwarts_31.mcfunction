...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Os monitores costumam ficar nessa sala de estudos atrás de mim, caso você precise perguntar algo pra um deles. \\n\\n\\n\\n\"}"}
