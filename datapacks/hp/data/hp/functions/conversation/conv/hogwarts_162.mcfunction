...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I am so clever that I sometimes don't understand a single word of what I am saying. \\n\\n\\n\\n\"}"}
