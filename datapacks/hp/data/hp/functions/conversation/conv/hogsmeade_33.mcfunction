...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Ouvi dizer que Hogwarts tem um novo professor de Trato das Criaturas Mágicas. O velho Kettleburn finalmente se aposentou. \\n\\n\\n\\n\"}"}
