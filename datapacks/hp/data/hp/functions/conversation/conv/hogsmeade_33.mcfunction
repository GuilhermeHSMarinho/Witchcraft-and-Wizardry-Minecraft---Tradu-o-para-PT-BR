...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Did you hear that Hogwarts has a new Care of Magical Creatures teacher? Old Kettleburn finally retired. \\n\\n\\n\\n\"}"}
