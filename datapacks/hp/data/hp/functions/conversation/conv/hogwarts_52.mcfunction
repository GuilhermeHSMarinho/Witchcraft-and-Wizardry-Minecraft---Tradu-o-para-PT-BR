...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I've been at Hogwarts for years now, but I never quite get used to these moving paintings. \\n\\n\\n\\n\"}"}
