...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Bem-vindo à Green Leaf, querido(a). Como posso ajudar você? Aqui trabalhamos principalmente com ervas e ingredientes alquímicos, coisas desse tipo.\"}"}
