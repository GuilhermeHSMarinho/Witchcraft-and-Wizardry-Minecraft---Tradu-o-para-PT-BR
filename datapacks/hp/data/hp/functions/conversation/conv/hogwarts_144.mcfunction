...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" You know, it turns out a Beater's bat is useful for whacking Bludgers and Gryffindors alike. \\n\\n\\n\\n\"}"}
