...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" The Three Broomsticks and I go back further than I care to admit. I can remember when it was just one broomstick. \\n\\n\\n\\n\"}"}
