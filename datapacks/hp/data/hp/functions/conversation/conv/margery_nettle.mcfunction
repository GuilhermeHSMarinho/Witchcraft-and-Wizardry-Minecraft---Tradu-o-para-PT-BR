...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" My family has had this shop for generations, and now this Mulpepper fellow has nearly put us out of business! \\n\\n\\n\\n\"}"}
