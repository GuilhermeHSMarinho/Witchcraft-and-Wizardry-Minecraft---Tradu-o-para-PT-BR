...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Did you hear that a Muggle accidentally got into Diagon Alley? Must have been quite a shock. \\n\\n\\n\\n\"}"}
