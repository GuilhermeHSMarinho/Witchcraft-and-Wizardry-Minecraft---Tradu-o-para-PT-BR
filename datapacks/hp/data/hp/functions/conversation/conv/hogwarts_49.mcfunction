...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" What's this? Ah. My package from Borgin and Burkes. I've been expecting this. \\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
