...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Mugglemaníaco Maddock deve sair do Magpies, diz McLeod.” Uma reação meio forte, não acha? \\n\\n\\n\\n\"}"}
