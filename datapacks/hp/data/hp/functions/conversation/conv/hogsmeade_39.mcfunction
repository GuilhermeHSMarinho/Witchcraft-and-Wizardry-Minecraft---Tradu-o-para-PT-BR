...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" 'Mugglemaniac Maddock must quit Magpies says McLeod'. Bit of a strong reaction, don't you think? \\n\\n\\n\\n\"}"}
