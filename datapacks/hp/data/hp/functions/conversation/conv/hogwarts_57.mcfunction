...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Up, down, left, right... I've lost count of how many turns there are in this bloody castle! \\n\\n\\n\\n\"}"}
