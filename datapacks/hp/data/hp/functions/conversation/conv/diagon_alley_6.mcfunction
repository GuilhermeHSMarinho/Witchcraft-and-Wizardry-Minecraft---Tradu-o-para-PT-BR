...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I need to buy some potions. I'm running short, and was never very good with the cauldron. \\n\\n\\n\\n\"}"}
