...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I was looking forward to playing Snake Pit in the courtyard, but I think someone has stolen my gobstones... \\n\\n\\n\\n\"}"}
