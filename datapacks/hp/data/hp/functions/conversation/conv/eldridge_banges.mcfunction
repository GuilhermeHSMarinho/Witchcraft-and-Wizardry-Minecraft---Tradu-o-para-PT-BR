...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Unless we have specific business, I'm not interested. Go talk to Dervish inside. He can help you. \\n\\n\\n\\n \"}"}
