...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" They say Gringotts is the safest place on Earth. It's certainly not the friendliest. \\n\\n\\n\\n\"}"}
