...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Aquele ali é o Cabeça de Javali. Não é dos mais acolhedores entre os pubs. \\n\\n\\n\\n\"}"}
