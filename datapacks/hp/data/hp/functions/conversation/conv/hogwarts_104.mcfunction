...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Have you ever visited Magical Menagerie in Diagon Alley? They have all kinds of magical creatures. \\n\\n\\n\\n\"}"}
