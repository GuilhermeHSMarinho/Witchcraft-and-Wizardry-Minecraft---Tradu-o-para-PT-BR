# Esse é o sistema de barreira que impede que o jogador saia da área jogável.

# Remova a tag do teste anterior
tag @s remove leavingPlayableArea
tag @s remove leftPlayableArea

###############
# Ponto de redefinição #
###############

# Verifique se o jogador está saindo da área jogável
...
########################################################################
# Bloquear algumas áreas até que o jogador tenha concluído determinadas ações importantes #
########################################################################
